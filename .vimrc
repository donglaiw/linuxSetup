...
"nmap <C-i> :TlistOpen 
"nmap <C-u> :TlistClose
" paste during insert mode without auto-indent
set pastetoggle=<F2>
" drag windows around
:nmap <C-p> :call DragRight()<return>
:nmap <C-o> :call DragLeft()<return>
function! DragRight()
    let n = tabpagenr()
...
if has("gui_running")
    ...
    set t_Co=256
    "colorschem cloudsxterm
    colorschem vitamins
    "colorschem espresso-soda
    "colorschem badwolf
    "colorschem torte
endif
